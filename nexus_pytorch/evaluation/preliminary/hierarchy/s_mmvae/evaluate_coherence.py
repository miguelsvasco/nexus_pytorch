...
import nexus_pytorch.evaluation.preliminary.hierarchy.s_mmvae.ingredients as ingredients
from nexus_pytorch.scenarios.multimodal_dataset.multimodal_dataset import MultimodalDataset
import nexus_pytorch.evaluation.preliminary.hierarchy.s_mmvae.model.training_utils as utils

ex = sacred.Experiment(
    'hierarchy_s_mmvae_evaluate_coherence',
    ingredients=[
