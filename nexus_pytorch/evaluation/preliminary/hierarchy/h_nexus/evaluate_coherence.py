...
import nexus_pytorch.evaluation.preliminary.hierarchy.h_nexus.ingredients as ingredients
from nexus_pytorch.scenarios.multimodal_dataset.multimodal_dataset import MultimodalDataset
import nexus_pytorch.evaluation.preliminary.hierarchy.h_nexus.model.training_utils as utils

ex = sacred.Experiment(
    'hierarchy_h_nexus_evaluate_coherence',
    ingredients=[
...
def evaluate_recon(model, img_class, dataloader, n_samples, cuda):
    ...
    with torch.no_grad():
        ...
        print("\nCoherence = " + str((img_res['cm'] + sym_res['cm']) / 2.))
        print("\n")
