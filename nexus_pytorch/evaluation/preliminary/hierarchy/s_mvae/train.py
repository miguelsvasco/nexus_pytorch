...
from nexus_pytorch.evaluation.preliminary.hierarchy.s_mvae.model.trainer import Trainer
from nexus_pytorch.evaluation.preliminary.hierarchy.s_mvae.model.model import MVAE
...
def post_cb(info):
    ex.add_artifact(
        os.path.join(
            log_dir_path('trained_models'), 's_mvae_checkpoint.pth.tar'),
        name='s_mvae_last_checkpoint.pth.tar')
    ex.add_artifact(
        os.path.join(
            log_dir_path('trained_models'), 'best_s_mvae_model.pth.tar'),
        name='best_s_mvae_model.pth.tar')
